...
export declare const api: typeof import("@cityofzion/neon-api/lib/plugin"), nep5: typeof import("@cityofzion/neon-nep5/lib/plugin"), settings: typeof neonCore.settings, sc: typeof neonCore.sc, rpc: typeof neonCore.rpc, wallet: typeof neonCore.wallet, CONST: typeof neonCore.CONST, u: typeof neonCore.u, tx: typeof neonCore.tx, logging: typeof neonCore.logging;
declare const _default: {
    sendAsset: typeof import("@cityofzion/neon-api").sendAsset;
    claimGas: typeof import("@cityofzion/neon-api").claimGas;
    doInvoke: typeof import("@cityofzion/neon-api").doInvoke;
    setupVote: typeof import("@cityofzion/neon-api").setupVote;
    create: {
